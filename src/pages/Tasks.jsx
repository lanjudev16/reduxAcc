        ...
        <div className="grid grid-cols-3 gap-5 mt-10">
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                pendingTasks?.map((item, index) => <TaskCard key={index} task={item}></TaskCard>)
              }
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                runningTasks?.map((item, index) => <TaskCard key={index} task={item}></TaskCard>)
              }
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {
                doneTasks?.map((item, index) => <TaskCard key={index} task={item}></TaskCard>)
              }
            </div>
          </div>
        </div>
